...
namespace TestSiaqodbBuckets
{
    ...
    {
        string siaqodb1Path= @"c:\work\temp\buk_tests\sync1\";
        string siaqodb2Path = @"c:\work\temp\buk_tests\sync2\";
        ...
        {
            using (Siaqodb siaqodb1 = new Siaqodb(siaqodb1Path))
            {
                using (Siaqodb siaqodb2 = new Siaqodb(siaqodb2Path))
                {
                    using (SiaqodbSync syncContext = this.GetSyncContext())
                    {
                        ...
                        IBucket bucket2 = siaqodb2.Documents["persons"];
                        {
                            ...
                            f.Value = userName;
                            var presult = await syncContext.PullAsync(bucket2);
                ...
                using (Siaqodb siaqodb2 = new Siaqodb(siaqodb2Path))
                {
                    ...
                    using (SiaqodbSync syncContext = this.GetSyncContext())
                    {
                        ...
                        IBucket bucket2 = siaqodb2.Documents["persons"];
                        {
                            ...
                            var resfsd = await syncContext.PullAsync(bucket2, query);
