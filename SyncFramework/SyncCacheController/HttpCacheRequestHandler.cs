    ...
    class HttpCacheRequestHandler : CacheRequestHandler
    {
        ...
        void ProcessRequest(AsyncArgsWrapper wrapper)
        {
            try
            {
                ...
                webRequest.ContentType = (base.SerializationFormat == SerializationFormat.ODataJSON) ? "application/atom+xml" : "application/json";
        ...
        void OnUploadGetRequestStreamCompleted(IAsyncResult asyncResult)
        {
            ...
            try
            {
                ...
                {
                    this._syncWriter.WriteFeed(new XmlJsonWriter(requestStream));
                }
