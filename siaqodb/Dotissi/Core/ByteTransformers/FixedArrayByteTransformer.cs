...
namespace Dotissi.Core
{
    class FixedArrayByteTransformer:IByteTransformer
    {
        ...
        public byte[] GetBytes(object obj)
        {
            ...
            int elementTypeId = Dotissi.Meta.MetaExtractor.GetAttributeType(elementType);
            int elementSize = Dotissi.Meta.MetaExtractor.GetSizeOfField(elementTypeId);
            ...
            {
                byte[] elemArray = null;
                if (elementTypeId == Dotissi.Meta.MetaExtractor.complexID)
                {
                ...
                else
                {
                    ...
                    if (elem == null)
                    {
                     ...
                     elemArray = ByteConverter.SerializeValueType(elemObj, elemObj.GetType(), elementSize, Dotissi.Meta.MetaExtractor.GetAbsoluteSizeOfField(elementTypeId), ti.Header.version);
                }
