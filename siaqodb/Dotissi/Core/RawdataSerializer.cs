...
namespace Dotissi.Core
{
    class RawdataSerializer
    {
        ...
        public byte[] SerializeArray(object obj, Type objectType, int length, int realLength, int dbVersion, Sqo.Utilities.ATuple<int, int> arrayMeta, ObjectSerializer objSerializer,bool elementIsText)
        {
            ...
            Dotissi.MetaObjects.ArrayInfo arrayInfo = this.SerializeArray(obj, objectType, objSerializer, dbVersion, elementIsText);
...
#if ASYNC_LMDB
        public async Task<byte[]> SerializeArrayAsync(object obj, Type objectType, int length, int realLength, int dbVersion, Sqo.Utilities.ATuple<int, int> arrayMeta, ObjectSerializer objSerializer, bool elementIsText)
        {
            ...
            Dotissi.MetaObjects.ArrayInfo arrayInfo = await this.SerializeArrayAsync(obj, objectType, objSerializer, dbVersion, elementIsText).ConfigureAwait(false);
        ...
        private Dotissi.MetaObjects.ArrayInfo SerializeArray(object obj, Type objectType, ObjectSerializer objSerializer, int dbVersion, bool elementIsText)
        {

            Dotissi.MetaObjects.ArrayInfo arrInfo = new Dotissi.MetaObjects.ArrayInfo();
            ...
            else
            {
                ...
                foreach (object elem in ((IList)obj))
                {
                    ...
                    else if (elementTypeId == MetaExtractor.jaggedArrayID)
                    {
                        ...
                        {
                            Dotissi.MetaObjects.ArrayInfo arrElemInfo = SerializeArray(elem, elementType, objSerializer, dbVersion, elementIsText);
...
#if ASYNC_LMDB
        private async Task<Dotissi.MetaObjects.ArrayInfo> SerializeArrayAsync(object obj, Type objectType, ObjectSerializer objSerializer, int dbVersion, bool elementIsText)
        {
            ...
            else
            {
                ...
                foreach (object elem in ((IList)obj))
                {
                    ...
                    else if (elementTypeId == MetaExtractor.jaggedArrayID)
                    {
                        ...
                        {
                            Dotissi.MetaObjects.ArrayInfo arrElemInfo = await SerializeArrayAsync(elem, elementType, objSerializer, dbVersion, elementIsText).ConfigureAwait(false);
                            byte[] jaggedArray = arrElemInfo.rawArray;
        ...
        public byte[] SerializeDictionary(object obj, int length, int dbVersion, Dotissi.MetaObjects.DictionaryInfo dictInfo, ObjectSerializer objSerializer)
        {
            byte[] b = new byte[length];
            if (obj == null)
            {
            ...
            Sqo.Utilities.ATuple<int, int> arrayMeta = new Sqo.Utilities.ATuple<int, int>(dictInfo.RawOID, nrElements);
...
#if ASYNC_LMDB
        public async Task<byte[]> SerializeDictionaryAsync(object obj, int length, int dbVersion, Dotissi.MetaObjects.DictionaryInfo dictInfo, ObjectSerializer objSerializer)
        {
            byte[] b = new byte[length];
            if (obj == null)
            {
...
#endif
        private RawdataInfo GetNewRawinfo(Sqo.Utilities.ATuple<int, int> arrayMeta, int rawLength,int elemLength,int nrElem)
        {
...
#if ASYNC_LMDB
        private async Task<RawdataInfo> GetNewRawinfoAsync(Sqo.Utilities.ATuple<int, int> arrayMeta, int rawLength, int elemLength, int nrElem)
        {
            if (arrayMeta == null || arrayMeta.Name == 0 || _transactionCommitStarted)//insert
            {
