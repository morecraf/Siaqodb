...
namespace Dotissi
{
    internal class QueryTranslator : ExpressionVisitor
    {
        ...
        protected override Expression VisitMethodCall(MethodCallExpression m)
        {
            ...
            throw new Sqo.Exceptions.LINQUnoptimizeException(string.Format("The method '{0}' is not supported", m.Method.Name));
        ...
        private void HandleIListMethods(MethodCallExpression m)
        {
            ...
            switch (m.Method.Name)
            {
                ...
                //    }
                default:
                    throw new Sqo.Exceptions.LINQUnoptimizeException("Unsupported string filtering query expression detected. ");
            }
        }
            ...
            if (m.Expression != null && (m.Expression.NodeType == ExpressionType.Parameter || m.Expression.NodeType == ExpressionType.MemberAccess))
            {
...
#endif
				{
					...
					else
					{
                        ...
                        {
                            throw new Sqo.Exceptions.LINQUnoptimizeException(string.Format("The member '{0}' is not supported", m.Member.Name));
