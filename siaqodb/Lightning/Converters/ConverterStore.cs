...
namespace LightningDB.Converters
{
    ...
    /// </summary>
    internal class ConverterStore
    {
        private readonly IDictionary<Type, object> _convertToBytes = new Dictionary<Type, object>(); 
        private readonly IDictionary<Type, object> _convertFromBytes = new Dictionary<Type, object>(); 
