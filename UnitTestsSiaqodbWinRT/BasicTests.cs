...
namespace SiaqodbUnitTests
{
    ...
    public class BasicTests
    {
        ...
        [TestMethod]
        public async Task TestUpdateObjectByAsync()
        {
            Siaqodb sq = new Siaqodb();
            await sq.OpenAsync(dbFolder);
            await sq.DropTypeAsync<ItemUnique>();
        ...
        public async Task TestUpdateObjectByAsyncDuplicates()
        {
            bool exTh = false;
            try
            {
        ...
        public async Task TestUpdateObjectByAsyncFieldNotExists()
        {
          bool exTh = false;
            try
            {
        ...
        public async Task TestUpdateObjectByAsyncManyFieldsDuplicates()
        {
            bool exTh = false;
            try
            {
        ...
        [TestMethod]
        public async Task TestUpdateObjectByAsyncManyFields()
        {
            Siaqodb sq = new Siaqodb(); await sq.OpenAsync(dbFolder);
            await sq.DropTypeAsync<Employee>();
        ...
        [TestMethod]
        public async Task TestDeleteObjectByAsync()
        {
            Siaqodb sq = new Siaqodb(); await sq.OpenAsync(dbFolder);
            await sq.DropTypeAsync<Employee>();
        ...
        public async Task TestUpdateObjectByAsyncManyFieldsConstraints()
        {
            bool exTh = false;
            try
            {
        ...
        [TestMethod]
        public async Task TestIndexUpdateObjectByAsync()
        {
            Siaqodb sq = new Siaqodb(); await sq.OpenAsync(dbFolder);
            await sq.DropTypeAsync<ClassIndexes>();
            for (int i = 0; i < 100; i++)
        ...
        public async Task TestTransactionInsert()
        {
            ...
            {
                needRollbackAsync = true;
            }
            if (needRollbackAsync)
            {
        ...
        public async Task TestTransactionDelete()
        {
            ...
            list = await sq.LoadAllAsync<Customer>();
            sq.DeleteAsync(list[0], transact);
            sq.DeleteAsync(list[1], transact);
            bool RollbackAsync = false;
            try
            {
                await transact.CommitAsync();
            }
        ...
        [TestMethod]
        public async Task TestUpdateObjectByAsyncManyFieldsTransaction()
        {
            Siaqodb sq = new Siaqodb(); await sq.OpenAsync(dbFolder);
            await sq.DropTypeAsync<Employee>();
        ...
        [TestMethod]
        public async Task TestDeleteObjectByAsyncTransactions()
        {
            Siaqodb sq = new Siaqodb(); await sq.OpenAsync(dbFolder);
            await sq.DropTypeAsync<Employee>();
        ...
        public async Task TestTransactionCrash()
        {
            ...
            await transac2t.CommitAsync();//here do debug and stop after a few CommitAsyncs to be able to simulate crash recovery
        }
        //TODO
        [TestMethod]
